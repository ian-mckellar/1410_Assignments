...
public class ListVsSetGui extends JFrame {
	...
	private JPanel createDemoPanel() {
		...
		JRadioButton rdbtnAddElements = new JRadioButton("Add Elements");
		...
		controlPanel.add(rdbtnAddElements);
	...
	private JPanel createMainDifferencePanel() {
		...
		txtrTheMain.setText("The 2 main differences between interface List and Set are: \n"
				+ "there can only be one of each unique item in a set while"
				+ " a list can \nhold many of the same items, a list can hold duplicates of\nunique items."
				+ "Where a set is group of unique elements, \na set has no order.");
